...
public class AltaCuponera extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        spinnerFechaFin.setModel(new SpinnerDateModel(new Date(1662346800000L), new Date(1662346800000L), null, Calendar.DAY_OF_YEAR));
        
        JLabel jLabelFechaFin = new JLabel("Fecha Fin");
        
        JSpinner spinnerDescueto = new JSpinner();
        spinnerDescueto.setModel(new SpinnerNumberModel(0, 0, 100, 1));
        	...
        	layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(layout.createSequentialGroup()
        			...
        			.addGroup(layout.createParallelGroup(Alignment.LEADING)
        				...
        				.addGroup(Alignment.TRAILING, layout.createSequentialGroup()
        					.addGroup(layout.createParallelGroup(Alignment.LEADING)
        						.addComponent(spinnerDescueto, GroupLayout.DEFAULT_SIZE, 192, Short.MAX_VALUE)
        						.addComponent(spinnerFechaFin, GroupLayout.PREFERRED_SIZE, 192, Short.MAX_VALUE)
        						.addComponent(spinnerFechaIni, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 192, Short.MAX_VALUE))
        	...
        	layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(layout.createSequentialGroup()
        			...
        			.addGroup(layout.createParallelGroup(Alignment.BASELINE)
        				.addComponent(labelFechaIni)
        				.addComponent(spinnerFechaIni, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
        			.addPreferredGap(ComponentPlacement.UNRELATED)
        			.addGroup(layout.createParallelGroup(Alignment.BASELINE)
        				.addComponent(spinnerFechaFin, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
        				.addComponent(jLabelFechaFin))
        			.addPreferredGap(ComponentPlacement.UNRELATED)
        			.addGroup(layout.createParallelGroup(Alignment.BASELINE)
        				.addComponent(spinnerDescueto, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
        				.addComponent(jLabelDescuento))
    ...
    private void botonAceptarActionPerformed(java.awt.event.ActionEvent evt) {
    	...
    	String nombreProfe = textDescripcion.getText();
    	LocalDateTime fechaInicio = convertirALocalDateTime(((Date)this.spinnerFechaIni.getValue()));
    	LocalDateTime fechaFin = convertirALocalDateTime(((Date)this.spinnerFechaFin.getValue()));
        LocalDate fechaAlta = LocalDate.now();
                
        /*if(sociosMin > sociosMax){
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(AltaCuponera.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
