...
public class AltaClase extends javax.swing.JFrame {
    ...
    public AltaClase() {
        ...
        this.lblNomClase.setVisible(false);
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
        	jPanel1Layout.createParallelGroup(Alignment.LEADING)
        		.addComponent(botonAceptar, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 118, Short.MAX_VALUE)
        );
        jPanel1Layout.setVerticalGroup(
        	jPanel1Layout.createParallelGroup(Alignment.TRAILING)
        		.addGroup(jPanel1Layout.createSequentialGroup()
        			.addContainerGap(268, Short.MAX_VALUE)
        			.addComponent(botonAceptar, GroupLayout.PREFERRED_SIZE, 29, GroupLayout.PREFERRED_SIZE))
        );
        ...
        lblURL.setText("URL asociada");

        lblNomClase.setText("Nom. Clase");
        		...
        		.addGroup(layout.createSequentialGroup()
        			.addGroup(layout.createParallelGroup(Alignment.LEADING)
        					...
        					.addGroup(layout.createParallelGroup(Alignment.LEADING)
        						...
        						.addGroup(layout.createSequentialGroup()
        							...
        							.addGroup(layout.createParallelGroup(Alignment.LEADING)
        								...
        								.addGroup(layout.createSequentialGroup()
        									.addComponent(comboActiDepo, GroupLayout.PREFERRED_SIZE, 158, GroupLayout.PREFERRED_SIZE)
        									.addPreferredGap(ComponentPlacement.RELATED)
        									.addComponent(labelActiDepo))
        								.addGroup(layout.createSequentialGroup()
        									.addComponent(comboInsti, GroupLayout.PREFERRED_SIZE, 158, GroupLayout.PREFERRED_SIZE)
        									.addPreferredGap(ComponentPlacement.RELATED)
        									.addComponent(jLabel3))
        								.addComponent(textURL, GroupLayout.PREFERRED_SIZE, 190, GroupLayout.PREFERRED_SIZE)
        								.addComponent(textNomClase, GroupLayout.PREFERRED_SIZE, 191, GroupLayout.PREFERRED_SIZE)))
        						.addGroup(layout.createSequentialGroup()
        							.addGap(15)
        							.addComponent(comboProfe, GroupLayout.PREFERRED_SIZE, 232, GroupLayout.PREFERRED_SIZE)
        							.addGap(5)
        				...
        				.addGroup(layout.createSequentialGroup()
        					...
        					.addPreferredGap(ComponentPlacement.RELATED)
        					.addComponent(spinnerMin, GroupLayout.PREFERRED_SIZE, 70, GroupLayout.PREFERRED_SIZE)
        					.addPreferredGap(ComponentPlacement.RELATED)
        					.addComponent(labelMin)
        					.addPreferredGap(ComponentPlacement.RELATED, 38, Short.MAX_VALUE)
        					.addComponent(spinnerMax, GroupLayout.PREFERRED_SIZE, 70, GroupLayout.PREFERRED_SIZE)
        					.addPreferredGap(ComponentPlacement.RELATED)
        				...
        				.addGroup(layout.createSequentialGroup()
        					...
        					.addGroup(layout.createParallelGroup(Alignment.TRAILING)
        						.addComponent(lblURL)
        						.addGroup(layout.createSequentialGroup()
        							.addComponent(spinnerFechaIni, GroupLayout.PREFERRED_SIZE, 131, GroupLayout.PREFERRED_SIZE)
        							.addPreferredGap(ComponentPlacement.RELATED)
        							.addComponent(labelMMDDAA1)
        							.addPreferredGap(ComponentPlacement.RELATED)
        							.addComponent(labelFechaIni))
        						.addComponent(lblNomClase))))
        			.addPreferredGap(ComponentPlacement.RELATED)
        ...
        layout.setVerticalGroup(
        	layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(layout.createSequentialGroup()
        			...
        			.addGroup(layout.createParallelGroup(Alignment.BASELINE)
        				.addComponent(comboActiDepo, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
        				.addComponent(labelActiDepo))
        			.addPreferredGap(ComponentPlacement.UNRELATED)
        			.addGroup(layout.createParallelGroup(Alignment.BASELINE)
        				.addComponent(textNomClase, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
        				.addComponent(lblNomClase))
        			.addPreferredGap(ComponentPlacement.UNRELATED)
        			.addGroup(layout.createParallelGroup(Alignment.BASELINE)
        			...
        			.addPreferredGap(ComponentPlacement.UNRELATED)
        			.addGroup(layout.createParallelGroup(Alignment.BASELINE)
        				.addComponent(comboProfe, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
        				.addComponent(labelProfe))
        			.addPreferredGap(ComponentPlacement.UNRELATED)
        			.addGroup(layout.createParallelGroup(Alignment.BASELINE)
        				.addComponent(labelSocios)
        ...
        if(sociosMin > sociosMax){//control de valores Socios
            ...
            if(comboActiDepo.getSelectedIndex() == 0 || comboProfe.getSelectedIndex() == 0 || URL.equals("") || comboInsti.getSelectedIndex() == 0 || nombreClase.equals("")){
                ...
                try {
                	...
                	VentanaMensaje ventanaExito = new VentanaMensaje("EXITO!", "Se dió de alta la clase!", java.awt.Color.GREEN.darker());
    ...
    private void comboInstiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboInstiActionPerformed
        if(this.comboInsti.getSelectedIndex() != 0){
            ...
            this.lblNomClase.setVisible(true);
